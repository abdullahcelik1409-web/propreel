...
export default function LemonSqueezyPaymentSuccessPage() {
  return (
    <main className="min-h-screen bg-[var(--pr-bg)] px-6 py-20 text-white">
      <div className="mx-auto max-w-2xl rounded-lg border border-[var(--pr-border-soft)] bg-[var(--pr-surface)] p-8">
        ...
        <p className="mt-4 text-sm leading-6 text-[var(--pr-muted)]">
          Lemon Squeezy has received the checkout flow. Viseo credits are added only after the signed Lemon Squeezy webhook confirms the completed order, which usually takes a few seconds.
        </p>

  ...
  return (
    <main className="pr-shell min-h-screen">
      ...
      <section className="mx-auto max-w-7xl px-6 py-14">
        ...
        <PricingFaq providerDisplayName={providerConfig.displayName} paymentSecurityText={providerConfig.paymentProcessorText} />
        <div className="pr-section mt-8 p-5">
          ...
          <div className="mt-4 grid gap-3 text-sm leading-7 text-[var(--pr-muted)] md:grid-cols-2">
            ...
            <p>- {providerConfig.displayName} checkout opens securely when a package is selected.</p>
            <p>- Payments are priced in USD. {providerConfig.taxInvoiceText}</p>
            <p>- No subscription; one-time purchase.</p>
            <p>- Unused credits are refundable; see our Cancellation Policy.</p>
            <p>- Available payment methods depend on {providerConfig.displayName} checkout settings and buyer location.</p>
            <p>

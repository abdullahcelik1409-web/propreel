...
const sellerPhoneEn = SELLER_INFO.phone ? `, phone ${SELLER_INFO.phone}` : "";
const sellerPhoneTr = SELLER_INFO.phone ? `, telefon ${SELLER_INFO.phone}` : "";
const sellerEn = `${SELLER_INFO.displayName}, ${SELLER_INFO.address}${sellerPhoneEn}, email ${SELLER_INFO.email}`;
const sellerTr = `${SELLER_INFO.displayName}, ${SELLER_INFO.address}${sellerPhoneTr}, e-posta ${SELLER_INFO.email}`;
const paymentProvider = getActivePaymentProviderConfig();
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            paymentProvider.privacyPaymentText,
          ],
        },
        {
          ...
          body: [
            ...
            `Service providers may include Fal.ai for AI video generation, ${paymentProvider.displayName} for payment processing, Vercel for hosting, Supabase for database/storage, Google for OAuth login, and email/contact service providers where applicable.`,
          ],
        },
        {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            `Kart bilgileri Viseo tarafÄ±ndan saklanmaz. Aktif Ã¶deme saÄŸlayÄ±cÄ±sÄ± ${paymentProvider.displayName}. ${paymentProvider.privacyPaymentText}`,
          ],
        },
        {
          ...
          body: [
            ...
            `Veriler; Fal.ai, ${paymentProvider.displayName}, Vercel, Supabase, Google OAuth ve gerekli teknik hizmet saÄŸlayÄ±cÄ±larla hizmetin yÃ¼rÃ¼tÃ¼lmesi amacÄ±yla paylaÅŸÄ±labilir. AktarÄ±m, KVKK ve ilgili mevzuattaki hukuki sebeplere dayanÄ±r.`,
          ],
        },
        {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            paymentProvider.termsPaymentText,
            paymentProvider.taxInvoiceText,
    ...
    tr: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            `Kredi paketlerinin fiyatÄ± Pricing sayfasÄ±nda USD olarak aÃ§Ä±kÃ§a gÃ¶sterilir. Ã–deme ${paymentProvider.displayName} checkout Ã¼zerinden tamamlanÄ±r. ${paymentProvider.termsPaymentText}`,
      ...
      sections: [
        {
          ...
          body: [
            `Refund requests for unused digital credits may be submitted within 14 days from purchase by emailing support, subject to applicable law. ${paymentProvider.refundLegalText}`,
        ...
        },
        {
          ...
          body: [
            `Refund objections, ${paymentProvider.displayName} payment questions, and digital delivery issues should be sent to ${SELLER_INFO.email} with the account email and package name.`,
          ],
        },
      ],
    },
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            paymentProvider.termsPaymentText,
            paymentProvider.taxInvoiceText,
            `Payment is completed through secure ${paymentProvider.displayName} checkout. Credits are delivered digitally after verified webhook confirmation.`,
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            `Ã–deme ${paymentProvider.displayName} checkout Ã¼zerinden tamamlanÄ±r. Krediler yalnÄ±zca doÄŸrulanmÄ±ÅŸ ${paymentProvider.displayName} webhook onayÄ±ndan sonra dijital olarak hesaba tanÄ±mlanÄ±r.`,

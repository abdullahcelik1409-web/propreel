      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            "Card data is not collected by Viseo because payments are intended to be completed through secure Shopier payment links.",
          ],
        },
        {
          ...
          body: [
            ...
            "Service providers may include Fal.ai for AI video generation, Shopier for payment processing, Vercel for hosting, Supabase for database/storage, Google for OAuth login, and email/contact service providers where applicable.",
          ],
        },
        {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            "Kart bilgileri Viseo tarafından saklanmaz. Ödemeler Shopier güvenli ödeme linkleri üzerinden tamamlanır.",
          ],
        },
        {
          ...
          body: [
            ...
            "Veriler; Fal.ai, Shopier, Vercel, Supabase, Google OAuth ve gerekli teknik hizmet sağlayıcılarla hizmetin yürütülmesi amacıyla paylaşılabilir. Aktarım, KVKK ve ilgili mevzuattaki hukuki sebeplere dayanır.",
          ],
        },
        {
    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            "The product is a digital service credit package priced in TRY as displayed on the Pricing page. No physical delivery is made.",
            "Payments are charged in Turkish lira through Shopier. International card issuers may apply their own exchange rate and fees.",
    ...
    tr: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            "Kredi paketlerinin fiyatı Pricing sayfasında TL/TRY olarak açıkça gösterilir. Ödeme Shopier güvenli ödeme linkleri üzerinden tamamlanır.",
    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            "Package names, credit amounts, and TRY prices are shown on the Pricing page before purchase.",
            "Payments are charged in Turkish lira through Shopier. International card issuers may apply their own exchange rate and fees.",
            "Payment is completed through secure Shopier payment links. Credits are delivered digitally after payment confirmation.",
    ...
    tr: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            "Paket adı, kredi miktarı ve TL/TRY fiyatı satın alma öncesinde Pricing sayfasında gösterilir.",
            "Ödeme Shopier güvenli ödeme linkleri üzerinden tamamlanır. Krediler ödeme onayından sonra dijital olarak hesaba tanımlanır.",

      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            "Card data is not collected by Viseo because payments are processed through Paddle Checkout. Paddle acts as merchant of record for payment, tax, invoice, and checkout handling.",
          ],
        },
        {
          ...
          body: [
            ...
            "Service providers may include Fal.ai for AI video generation, Paddle for payment processing and merchant-of-record services, Vercel for hosting, Supabase for database/storage, Google for OAuth login, and email/contact service providers where applicable.",
          ],
        },
        {
      ...
      sections: [
        {
          ...
          body: [
            `KVKK madde 10 kapsamında veri sorumlusu ${sellerTr}. Bu metin, ${SITE_URL} üzerinden sunulan Viseo dijital hizmetinin kullanımı sırasında kişisel verilerin nasıl işlendiğini açıklar.`,
          ],
        },
        {
          ...
          body: [
            ...
            "Kart bilgileri Viseo tarafından saklanmaz. Ödemeler Paddle Checkout üzerinden işlenir; ödeme, vergi ve fatura süreçlerinde Paddle merchant of record olarak görev yapar.",
          ],
        },
        {
          ...
          body: [
            ...
            "Veriler; Fal.ai, Paddle, Vercel, Supabase, Google OAuth ve gerekli teknik hizmet sağlayıcılarla hizmetin yürütülmesi amacıyla paylaşılabilir. Aktarım, KVKK ve ilgili mevzuattaki hukuki sebeplere dayanır.",
          ],
        },
        {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            "Payments are processed by Paddle as merchant of record. Paddle may calculate applicable taxes and final checkout totals based on buyer location.",
      ...
      sections: [
        {
          ...
          body: [
            `Satıcı: ${sellerTr}. Alıcı: Viseo üzerinden dijital kredi paketi satın alan kullanıcıdır.`,
        ...
        },
        {
          ...
          body: [
            "Kredi paketlerinin fiyatı Pricing sayfasında USD olarak açıkça gösterilir. Ödeme Paddle Checkout üzerinden tamamlanır ve Paddle merchant of record olarak ödeme, vergi ve fatura sürecini yürütür.",
            "Ödeme onayından sonra dijital krediler kullanıcının Viseo hesabına tanımlanır. Teslimat elektronik ortamda yapılır.",
          ],
        },
        {
      ...
      sections: [
        {
          ...
          body: [
            "Refund requests for unused digital credits may be submitted within 14 days from purchase by emailing support, subject to applicable law and Paddle policies.",
        ...
        },
        {
          ...
          body: [
            `Refund objections, Paddle payment questions, and digital delivery issues should be sent to ${SELLER_INFO.email} with the account email and package name.`,
          ],
        },
      ],
    },
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            "Payments are processed by Paddle as merchant of record. Paddle may calculate taxes and final totals at checkout.",
            "Payment is completed through secure Paddle Checkout. Credits are delivered digitally after verified webhook confirmation.",
      ...
      sections: [
        {
          ...
          body: [
            `Satıcı: ${sellerTr}.`,
            "Hizmet: Viseo üzerinde AI destekli emlak pazarlama videosu üretimi için kullanılan dijital kredi paketleridir.",
          ],
        },
        {
          ...
          body: [
            ...
            "Ödeme Paddle Checkout üzerinden tamamlanır. Krediler yalnızca doğrulanmış Paddle webhook onayından sonra dijital olarak hesaba tanımlanır.",

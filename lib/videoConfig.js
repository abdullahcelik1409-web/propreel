...
export const VIDEO_ASPECT_RATIOS = ["16:9", "1:1", "9:16"];

export function normalizeAspectRatio(value) {
  const normalized = String(value || "").trim().toLowerCase();
  if (normalized === "square" || normalized === "1:1") return "1:1";
  if (normalized === "vertical" || normalized === "portrait" || normalized === "9:16") return "9:16";
  return "16:9";
}
...
export const INITIAL_USER_CREDITS = 480;
...
export const CREDIT_PACKAGES = [
  {
    ...
    description: "A practical starter pack for first listings, quick tests, and polished basic property videos.",
  },
  {
    id: "growth_credits",
    name: "Growth Credits",
    ...
    currency: "USD",
    billingType: "one_time",
    description: "A flexible credit boost for agents producing regular listing content across multiple formats.",
  },
  {
    id: "agency_credits",
    name: "Agency Credits",
    ...
    currency: "USD",
    billingType: "one_time",
    description: "A stronger monthly pack for teams balancing multi-image tours and occasional premium showcases.",
  },
  {
    ...
    currency: "USD",
    billingType: "one_time",
    description: "The best fit for agents who want consistent premium campaigns without topping up every week.",
    badge: "Most Popular",
  },
  {
    ...
    currency: "USD",
    billingType: "one_time",
    description: "Built for luxury portfolios, agency teams, and high-volume premium video production.",
  },
];

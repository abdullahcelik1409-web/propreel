      ...
      <div className="w-full max-w-sm bg-[#0a0a0a]/90 backdrop-blur-xl border border-white/10 rounded-xl p-10 shadow-2xl relative">
        ...
        <div className="flex flex-col items-center text-center mb-10">
          ...
          <p className="text-white/40 text-[13px] leading-relaxed px-4">
            {subtitle || 'Enter an API key only if a future workflow requires a client-side credential.'}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-[#67e8f9] text-[#031014] font-bold py-2.5 rounded-md hover:bg-[#a7f3d0] hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-[#22d3ee]/5"
            suppressHydrationWarning
          >
            Get Started
          </button>
          ...
          <p className="text-center text-[12px] text-white/20 pt-2">
            Fal.ai credentials are read server-side from the project environment.
          </p>
        </form>
      </div>
    </div>
